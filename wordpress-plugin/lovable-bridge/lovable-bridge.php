...
class Lovable_Bridge {
    ...
    public function create_page($request) {
        ...
        // Invalidate any existing cache for this page
        $this->invalidate_cache($page_id);
    ...
    /**
     * Get page blocks with transient caching for performance.
     * Cached responses are returned in < 1ms vs ~50ms for uncached.
     */
    ...
    /**
     * Invalidate block cache when a post is saved/updated.
     */
